...
INSERT INTO `agencias` VALUES (1,'Especializada en viajes grupales y experiencias personalizadas','Mega Viajes','2025-01-15','Av. Universidad 1234, Chihuahua, Chih.','eimg1.png','megaviajes','megaviajes123','6141234567','contacto@megaviajes.com'),(2,'Agencia enfocada en turismo y paquetes culturales','Platinum Travels','2025-02-10','Av. Fco. Villa 4907, Plaza Arboledas Local 217, Chihuahua, Chih.','eimg2.png','platinum','platinum456','6142345678','info@platinumtravels.com'),(3,'Ofrece paquetes de viaje y asesoría personalizada para turistas','Al Viajar','2025-03-05','Av. Francisco Villa 4904-5, Arboledas, Chihuahua, Chih.','eimg3.png','alviajar','alviajar789','6143456789','contacto@alviajar.com'),(4,'Telecom','Silkcom','2026-04-11','Sin especificar','default.png','silkcom','dahlia','6141234567','silkcom@gmail.com');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `tr_insertaragencia` AFTER INSERT ON `agencias` FOR EACH ROW begin	
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `tr_actualizaragencia` BEFORE UPDATE ON `agencias` FOR EACH ROW begin	
		insert into bit_agencias(
			usuario,
            bit_descripcion,
            fecha,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `tr_eliminaragencia` BEFORE DELETE ON `agencias` FOR EACH ROW BEGIN
    INSERT INTO bit_agencias(
        usuario,
        bit_descripcion,
        fecha,
...
INSERT INTO `bit_agencias` VALUES ('arc_invitado@localhost','Agencia nueva','2026-04-11 06:05:39',4,NULL,'Telecom',NULL,'Silkcom',NULL,'Sin especificar',NULL,'silkcom',NULL,'dahlia',NULL,'6141234567',NULL,'silkcom@gmail.com');
...
INSERT INTO `bitclientes` VALUES (1,'root@localhost','2026-04-13 15:46:07','INSERT / Creacion de cliente',11,NULL,'cliente11',NULL,'cli013',NULL,'Mayen',NULL,'Palma',NULL,'m.p@correo.com',NULL,'6140000012'),(2,'root@localhost','2026-04-13 15:46:36','UPDATE / Modificacion de cliente',11,'cliente11','cliente11','cli013','cli013','Mayen','Jeremoth','Palma','Palma','m.p@correo.com','m.p@correo.com','6140000012','6140000012'),(3,'root@localhost','2026-04-13 15:47:14','DELETE / Eliminacion de cliente',11,'cliente11',NULL,'cli013',NULL,'Jeremoth',NULL,'Palma',NULL,'m.p@correo.com',NULL,'6140000012',NULL);
...
--
-- Table structure for table `bitorganizadoras`
--

DROP TABLE IF EXISTS `bitorganizadoras`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bitorganizadoras` (
  ...
  `old_password` varchar(255) DEFAULT NULL,
  `new_password` varchar(255) DEFAULT NULL,
  `old_descripcion_agencia` varchar(255) DEFAULT NULL,
  `new_descripcion_agencia` varchar(255) DEFAULT NULL,
  `old_nombre_agencia` varchar(255) DEFAULT NULL,
  `new_nombre_agencia` varchar(255) DEFAULT NULL,
  `old_fecha_registro` date DEFAULT NULL,
  `new_fecha_registro` date DEFAULT NULL,
  `old_direccion` varchar(255) DEFAULT NULL,
  `new_direccion` varchar(255) DEFAULT NULL,
  `old_imagen_url` varchar(255) DEFAULT NULL,
  `new_imagen_url` varchar(255) DEFAULT NULL,
...
--
-- Dumping data for table `bitorganizadoras`
--

LOCK TABLES `bitorganizadoras` WRITE;
/*!40000 ALTER TABLE `bitorganizadoras` DISABLE KEYS */;
INSERT INTO `bitorganizadoras` VALUES (1,'root@localhost','2026-04-13 16:14:41','INSERT / Creacion de organizadora',4,NULL,'a',NULL,'b',NULL,'c',NULL,'d',NULL,'2024-09-22',NULL,'e',NULL,'org4.png',NULL,'6141234567',NULL,'a@email.com'),(2,'root@localhost','2026-04-13 16:15:12','UPDATE / Modificacion de organizadora',4,'a','a','b','b','c','c','d','d','2024-09-22','2024-09-22','e','agua','org4.png','org4.png','6141234567','6141234567','a@email.com','a@email.com'),(3,'root@localhost','2026-04-13 16:15:42','DELETE / Eliminacion de organizadora',4,'a',NULL,'b',NULL,'c',NULL,'d',NULL,'2024-09-22',NULL,'agua',NULL,'org4.png',NULL,'6141234567',NULL,'a@email.com',NULL);
/*!40000 ALTER TABLE `bitorganizadoras` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `bitreservaciones` VALUES (1,'root@localhost','2026-04-13 16:31:43','INSERT / Creacion de reservacion','131',NULL,18,NULL,9,NULL,'pendiente'),(2,'root@localhost','2026-04-13 16:31:59','UPDATE / Modificacion de reservacion','131',18,18,9,9,'pendiente','cancelado'),(3,'root@localhost','2026-04-13 16:32:26','DELETE / Eliminacion de reservacion','131',18,NULL,9,NULL,'cancelado',NULL);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgClientesInsert` BEFORE INSERT ON `clientes` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgClientesUpdate` BEFORE UPDATE ON `clientes` FOR EACH ROW begin
INSERT INTO bitclientes (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgClientesDelete` BEFORE DELETE ON `clientes` FOR EACH ROW begin
INSERT INTO bitclientes (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgEventosInsert` AFTER INSERT ON `eventos` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgEventosUpdate` AFTER UPDATE ON `eventos` FOR EACH ROW BEGIN
    INSERT INTO biteventos (
        usuario, fecha_hora, accion, id_afectado,
        old_nombre, new_nombre,
        old_descripcion, new_descripcion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgEventosDelete` AFTER DELETE ON `eventos` FOR EACH ROW BEGIN
    INSERT INTO biteventos (
        usuario, fecha_hora, accion, id_afectado,
        old_nombre, new_nombre,
        old_descripcion, new_descripcion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgLugaresInsert` BEFORE INSERT ON `lugares` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgLugaresUpdate` BEFORE UPDATE ON `lugares` FOR EACH ROW begin
INSERT INTO bitlugares (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgLugaresDelete` BEFORE DELETE ON `lugares` FOR EACH ROW begin
INSERT INTO bitlugares (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgOrganizadorasInsert` BEFORE INSERT ON `organizadoras` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgOrganizadorasUpdate` BEFORE UPDATE ON `organizadoras` FOR EACH ROW begin
INSERT INTO bitorganizadoras (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgOrganizadorasDelete` BEFORE DELETE ON `organizadoras` FOR EACH ROW begin
INSERT INTO bitorganizadoras (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgPaquetesInsert` AFTER INSERT ON `paquetes` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgPaquetesUpdate` AFTER UPDATE ON `paquetes` FOR EACH ROW BEGIN
    INSERT INTO bitpaquetes (
        usuario, fecha_hora, accion, id_afectado,
        old_nombre_paquete, new_nombre_paquete,
        old_descripcion_paquete, new_descripcion_paquete,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgPaquetesDelete` AFTER DELETE ON `paquetes` FOR EACH ROW BEGIN
    INSERT INTO bitpaquetes (
        usuario, fecha_hora, accion, id_afectado,
        old_nombre_paquete, new_nombre_paquete,
        old_descripcion_paquete, new_descripcion_paquete,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgReservacionesInsert` BEFORE INSERT ON `reservaciones` FOR EACH ROW begin
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgReservacionesUpdate` BEFORE UPDATE ON `reservaciones` FOR EACH ROW begin
INSERT INTO bitreservaciones (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgReservacionesDelete` BEFORE DELETE ON `reservaciones` FOR EACH ROW begin
INSERT INTO bitreservaciones (
        usuario,
        fecha_hora,
        accion,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgViajesInsert` AFTER INSERT ON `viajes` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgViajesUpdate` AFTER UPDATE ON `viajes` FOR EACH ROW BEGIN
    INSERT INTO bitviajes (
        usuario, fecha_hora, accion, id_afectado,
        old_id_cliente, new_id_cliente,
        old_id_paquete, new_id_paquete,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 */ /*!50003 TRIGGER `trgViajesDelete` AFTER DELETE ON `viajes` FOR EACH ROW BEGIN
    INSERT INTO bitviajes (
        usuario, fecha_hora, accion, id_afectado,
        old_id_cliente, new_id_cliente,
        old_id_paquete, new_id_paquete,
...
-- Dump completed on 2026-05-13  8:36:46
